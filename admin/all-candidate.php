...
if(isset($_POST['trash']))
{
	...
	{
		$canup = "UPDATE srthi_nhtattend SET sr_status='2' WHERE sr_empid='$trash'";
						...
						<div class="table-wrapper-scroll-y my-custom-scrollbar">
							<table class="table table-bordered table-striped table-hover">
								...
								if(isset($_GET['tainer']))
								{
									...
									$num = 1;
									$sql = "SELECT * FROM `srthi_nhtattend` WHERE sr_heademail='$tainer' AND sr_status='1'";
								...
								else
								{
									...
									$num = 1;
									$sql = "SELECT * FROM `srthi_nhtattend`WHERE sr_status='1'";
									$res = mysqli_query($conn,$sql);
									while($row = mysqli_fetch_array($res))
									{
										?>
