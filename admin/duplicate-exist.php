						...
						<div class="table-wrapper-scroll-y my-custom-scrollbar">
							<table class="table table-bordered table-striped table-hover">
								...
								<?php
									...
									$num = 1;
									//$sql = "SELECT sr_batch,sr_empid,sr_name,sr_process,sr_suprocess,sr_password,sr_heademail FROM `srthi_nhtattend` WHERE sr_empid IN (SELECT sr_empid FROM `srthi_nhtattend` GROUP BY sr_empid HAVING COUNT(*) > 1)";
									$sql = "SELECT * FROM `duplicate_2_cell`";
