...
if(isset($_POST['consub']))
{
	...
	{
		$canup = "SELECT * FROM `srthi_nhtcan` WHERE sr_empid='$trash' AND sr_heademail='$temail' AND sr_status='1'";
...
<section class="main-branch">
	...
	<div class="content-bar">
		<div class="container">
			<div class="row py-4">
				<div class="col-lg-4">
					<h5 class="content-head-top"><span><a href="javascript:history.go(-1)"><img src="../assets/img/back.png"></a></span> NHT Training</h5>
				</div>
				<div class="col-lg-8">
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						if(isset($_GET['batch']) AND isset($_GET['pro']) AND isset($_GET['subpro']))
						{
							...
							$pro = $_GET['pro'];
							$subpro = $_GET['subpro'];
							$sql = "SELECT * FROM `srthi_nhtcan` WHERE sr_batch='$batch' AND sr_process='$pro' AND sr_subprocess='$subpro' AND sr_status='1' AND sr_heademail='$temail'";
						...
						{
							$num = 1;
							$sql = "SELECT * FROM `srthi_nhtcan` WHERE sr_status='1' AND sr_heademail='$temail'";
							$res = mysqli_query($conn,$sql);
							while($row = mysqli_fetch_array($res))
							{
								?>
