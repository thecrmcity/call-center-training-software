	...
	if(isset($_POST['submitscenerio']))
	{
		...
		if($cnum < 0)
		{
			$mts = "INSERT INTO `srthi_customerques`(`sr_batch`, `sr_empid`, `sr_empname`, `sr_empro`, `sr_emsubpro`, `sr_custid`, `sr_related`, `sr_subject`, `sr_message`, `sr_headmail`, `sr_status`, `sr_ative`,`sr_msgtype`) VALUES ('$ebatch','$uid','$uname','$epro','$esubpro','SIPMESS01','$customerques','$subjecttext','$messagetext','$ehead','1','1','Customerques')";
		...
		{
			$mts = "INSERT INTO `srthi_customerques`(`sr_batch`, `sr_empid`, `sr_empname`, `sr_empro`, `sr_emsubpro`, `sr_custid`, `sr_related`, `sr_subject`, `sr_message`, `sr_headmail`, `sr_status`, `sr_ative` ,`sr_msgtype`) VALUES ('$ebatch','$uid','$uname','$epro','$esubpro','$mnum','$customerques','$subjecttext','$messagetext','$ehead','1','1','Customerques')";
			mysqli_query($conn,$mts);
			$msg = '
					<table class="table table-bordered">
						<tr>
...
<section class="main-branch">
	...
	<div class="content-bar">
		<div class="container">
			<div class="row py-4">
				<div class="col-lg-4">
					<h4 class="content-head-top">Customer Questions</h4>
				</div>
				<div class="col-lg-8">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="changepa shadow p-5 bg-light rounded border border-secondary">
								<h5 class="text-center">Upload Scenarios / Customer Questions</h5>
