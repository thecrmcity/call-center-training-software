				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						if(isset($_GET['train']))
						{
							...
							$num =1;
							$sql = "SELECT DISTINCT sr_empid, sr_empname, sr_emprocess, sr_empsubpro, sr_batch,sr_correction,sr_testname,sr_result FROM srthi_assign_test WHERE sr_heademail='$train' AND sr_test_status='1'";
