...
<section class="main-branch">
	...
	<div class="content-bar">
		<div class="container">
			<div class="row py-4">
				<div class="col-lg-4">
					<h5 class="content-head-top"><span><a href="javascript:history.go(-1)"><img src="../assets/img/back.png"></a></span> Inactive Exist Employee</h5>
				</div>
				<div class="col-lg-8">
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar">
				<table class="table table-bordered table-striped table-hover">
					<thead class="bgsky">
						...
						<th class="sticky-top">Uploading Date</th>
					</thead>
					<tbody>
						<?php
						if(isset($_GET['tid']))
						{
							...
							$nsql = "SELECT * FROM `srthi_nhtattend` WHERE sr_heademail='$trn' AND sr_status!='1'";
