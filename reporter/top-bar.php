...
<nav class="navbar navbar-expand-md bgred navbar-dark">
	  ...
	  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	    <ul class="navbar-nav ml-auto">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="online-test.php"> Online Test</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="can-report.php"> Candidate</a>
	      </li>
	     
	      <li class="nav-item dropdown">
	        <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $anyname;?></a>
